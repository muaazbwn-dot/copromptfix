    ...
    <div className="flex min-h-[60vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-full border border-input px-5 py-2.5 text-sm font-medium text-foreground hover:bg-secondary"
          >
            Go home
          </a>
        </div>
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "WebSite",
          name: "Promptify",
          description: "Discover, copy and create with AI image prompts.",
          potentialAction: {
            "@type": "SearchAction",
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <head>
        <HeadContent />
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8851607227596455"
     crossOrigin="anonymous"></script>

  <script async src="https://www.googletagmanager.com/gtag/js?id=G-XG02BM5VEP"></script>
  <script
